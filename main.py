...
from bot.states import (ADMIN_MENU, MAIN_MENU, MOD_EVENT_TAGS, EVENT_CSV_IMPORT, AI_CHAT,
                       ...
                       EVENT_REPORT_FEEDBACK, LEADERBOARD_REGION_SELECT, LEADERBOARD_VIEW, EVENT_TAG_SELECT)
...
from bot.handlers.user import (handle_event_details, handle_main_menu, handle_ai_chat, handle_volunteer_home, handle_registration,
                               ...
                               handle_code_redemption, handle_employee_number, handle_leaderboard_region_select,
                               show_leaderboard, handle_event_tag_selection)  # Добавьте эту функцию в импорт
